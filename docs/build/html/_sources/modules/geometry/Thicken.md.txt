...
In this example, the scalar data field of a data set is first transformed into points via [ToPoints](../../modules/geometry/ToPoints.md) (see top-right image) and then thickened into spheres (see image in the center of the right image). The radii of the spheres depend on the scalar data field.
**Note:** To avoid rendering errors, it is important to pass the output to the [ToTriangles](../../modules/geometry/ToTriangles.md) module whose `transform spheres` parameter has been **enabled**.

Moreover, three-dimensional input data is transformed into a vector field through the [VectorField](../../modules/map/VectorField.md) module and the resulting lines are expanded into tubes (see bottom of the right image).

## Related Modules

### Often Used With

- [ToTriangles](../../modules/geometry/ToTriangles.md)
- [ToPoints](../../modules/geometry/ToPoints.md)
- [VectorField](../../modules/map/VectorField.md)
