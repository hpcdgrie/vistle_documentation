...
<text x="1.9em" y="0.9em" class="text" >triangles with mapped data<tspan> (grid_in)</tspan></text>
<text x="0.2em" y="3.6500000000000004em" class="moduleName" >FlattenTriangles</text><rect x="0.2em" y="3.8em" width="1.0em" height="1.0em" rx="0.0em" ry="0.0em" style="fill:#c8c81eff;" >
...
<text x="1.9em" y="5.8999999999999995em" class="text" >triangles with resolved indices<tspan> (grid_out)</tspan></text>
</svg>
