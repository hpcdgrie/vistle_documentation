...
In this example, the scalar data field of a data set is first transformed into points via [ToPoints](../../../module/geometry/ToPoints/ToPoints.md) (see top-right image) and then thickened into spheres (see image in the center of the right image). The radii of the spheres depend on the scalar data field.
**Note:** To avoid rendering errors, it is important to pass the output to the [ToTriangles](../../../module/geometry/ToTriangles/ToTriangles.md) module whose `transform spheres` parameter has been **enabled**.

Moreover, three-dimensional input data is transformed into a vector field through the [VectorField](../../../module/map/VectorField/VectorField.md) module and the resulting lines are expanded into tubes (see bottom of the right image).

## Related Modules

### Often Used With

- [ToTriangles](../../../module/geometry/ToTriangles/ToTriangles.md)
- [ToPoints](../../../module/geometry/ToPoints/ToPoints.md)
- [VectorField](../../../module/map/VectorField/VectorField.md)
